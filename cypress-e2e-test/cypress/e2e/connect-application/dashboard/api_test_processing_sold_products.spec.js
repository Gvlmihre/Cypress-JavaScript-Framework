...
describe('Run ConnectApp Public API Processing Of Sold Products Category 5.1 Tests', () => {
    ...
    it('ConnectApp Public API Processing Of Sold Products 5.1 Create New Emission Source POST Request Test', () => {
    ...
    it('ConnectApp Public API Processing Of Sold Products 5.1 GET Emission Sources Test', () => {
    ...
    it('ConnectApp Public API Processing Of Sold Products 5.1 GET Emission Sources Filter By String Test', () => {
    ...
    it('ConnectApp Public API Processing Of Sold Products 5.1 GET Calculated Carbon Footprints', () => {
    ...
    it('ConnectApp Public API Processing Of Sold Products 5.1 Calculate Carbon Footprint POST Request Test', () => {
        const locationId = getRandomArrayElement(locationIds)
    ...
    it('ConnectAppc APIProcessing Of Sold Products 5.1 Calculate Carbon Footprint POST Request Test - 400 Bad Request', () => {
        const locationId = getRandomArrayElement(locationIds)
        const amount = faker.mersenne.rand(1000, 1)
