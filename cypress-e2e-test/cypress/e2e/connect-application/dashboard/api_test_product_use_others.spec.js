...
describe('Run Connector Pro V2 Public API Category 4.6 Others Tests', () => {
    ...
    it('Connector Pro V2 Public API 4.6 Create New Emission Source POST Request Test', () => {
    ...
    it('Connector Pro V2 Public API 4.6 GET Emission Sources Test', () => {
    ...
    it('Connector Pro V2 Public API 4.6 GET Emission Sources Filter By String Test', () => {
    ...
    it('Connector Pro V2 Public API 4.6 GET Calculated Carbon Footprints', () => {
    ...
    it('Connector Pro V2 Public API 4.6 Calculate Carbon Footprint POST Request Test', () => {
        const locationId = getRandomArrayElement(locationIds)
    ...
    it('Connector Pro V2 Public API 4.6 Calculate Carbon Footprint POST Request Test - 400 Bad Request', () => {
        const locationId = getRandomArrayElement(locationIds)
        const amount = faker.mersenne.rand(1000, 1)
