...
describe('Run ConnectApp Public API Category 1 Fugitive Emissions tests', () => {
    ...
    it('ConnectApp Public API Fugitive Emissions GET Emission Sources Test', () => {
    ...
    it('ConnectApp Public API Fugitive Emissions GET Emission Sources Filter By String Test', () => {
    ...
    it('ConnectApp Public API Fugitive Emissions GET Devices Test', () => {
    ...
    it('ConnectApp Public API Fugitive Emissions GET Data Sources Test', () => {
    ...
    it('ConnectApp Public API Fugitive Emissions GET Calculated Carbon Footprints Test', () => {
    ...
    it('ConnectApp Public API Fugitive Emissions POST Calculate Carbon Footprint Test', () => {
        const locationId = getRandomArrayElement(locationIds)
    ...
    it('ConnectApp POST Calculate Carbon Footprint Test - 400 Bad Request', () => {
