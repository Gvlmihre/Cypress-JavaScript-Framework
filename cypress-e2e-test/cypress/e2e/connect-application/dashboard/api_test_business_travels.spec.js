...
describe('Run ConnectApp Public API Category 3.5 Business Travels Tests', () => {
    ...
    // ConnectAppPublic API Business Travels - Airway Tests Starts Here
    ...
    it(' ConnectApp Public API Business Travels Calculate Carbon Footprint POST Request Test - Airway', () => {
    ...
    it( ConnectApp Public API Business Travels Calculate Carbon Footprint POST Request 400 Bad Request Test - Others', () => {
